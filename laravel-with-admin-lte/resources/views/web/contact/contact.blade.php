    ...
    <div class="contact-bg">
        <div class="container">
            <div class="contact-index">
                <div class="row">
                    <div class="col-xs-12 col-md-3 contact-index__header-left"><h1>{{ 'ติดต่อ/สอบถาม' }}</h1></div>
                    <div class="col-xs-12 col-md-9 contact-index__header-right">
                ...
                <div class="row">
                    ...
                    @endif
                    <div class="col-xs-12 col-md-4 contact-index__content-form">
                    ...
                    <div class="col-xs-12 col-md-8 contact-index__content-map">
