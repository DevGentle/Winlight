...
class URLify
{
     ...
     * @return string
     */
    public static function slug($text, $length = 60)
    {
        $string = self::transliterate($text);
        ...
        return trim(mb_substr($string, 0, $length), '-') ?: $text;     // trim to first $length chars
    }
     ...
     * @return mixed
     */
    public static function typo($string)
    {
        return preg_replace('/^(ิ|ี|ุ|ู|่|้|๊|๋|ั|ํ|ึ|์|า|ๆ|ะ)/', '', $string);        // thai bad typo
    }
}